  ...
  return (
    <div className="homepage-container">
      <div className="bg-[url(/background.png)] flex flex-col items-center justify-center min-h-screen w-full bg-cover bg-center">
          ...
          <h1 className="homepage-title text-[#314000] text-5xl font-bold">Find a place to eat anywhere</h1>
          ...
          <div className="homepage-buttons mt-6">
            ...
            <form action="/results" method="get" className="inline-block ml-4">
                <input type="text" name="location" placeholder="Enter location manually" className="homepage-input px-2 py-3 rounded-xl bg-white border-1 border-[#314000] focus:outline-none text-center" />
